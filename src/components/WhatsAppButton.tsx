...
export default function WhatsAppButton() {
    const [message, setMessage] = useState('Online agora');
    const [isVisible, setIsVisible] = useState(false);

    useEffect(() => {
        // Show initial 'Online agora' (optional, or start hidden)
        setIsVisible(true);

        // After 10 seconds, change message to the CTA
        const timer = setTimeout(() => {
            setMessage('Precisa de ajuda com o seu AC?');
        }, 10000);
