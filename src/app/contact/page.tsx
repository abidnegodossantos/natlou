            ...
            <div className="container" style={{ marginTop: '-120px', position: 'relative', zIndex: 3 }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '0.5rem' }}>+244 946 776 397</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '1.5rem' }}>+244 955 475 575</p>
                    ...
                    <div style={{
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '0.5rem' }}>Atendimento Rápido</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '1.5rem' }}>Seg-Sáb</p>
                    ...
                    <div style={{
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '0.5rem' }}>natlou.limitada@gmail.com</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '1.5rem' }}>Respondemos em 24h</p>
                    ...
                    <div style={{
                        ...
                        <div style={{ padding: '2.5rem', backgroundColor: 'var(--bg-secondary)', borderRadius: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'flex-start' }}>
                                ...
                                <div>
                                    <h3 style={{ fontSize: '1.4rem', fontWeight: 'bold', marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Horário</h3>
                                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>Segunda a Sexta: 8h - 17h</p>
                                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>Sábado: 8h - 13h</p>
                                </div>
                            </div>
                        </div>
