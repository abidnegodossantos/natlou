            ...
            <div className="container" style={{ marginTop: '-120px', position: 'relative', zIndex: 3 }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h3 style={{ fontSize: '1.4rem', fontWeight: 'bold', marginBottom: '1rem', color: 'var(--text-primary)' }}>Ligue para Nós</h3>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '0.3rem', fontWeight: '700' }}>+244 946 776 397</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '1.5rem', fontWeight: '700' }}>+244 922 643 541</p>
                    ...
                    <div style={{
                        ...
                        <h3 style={{ fontSize: '1.4rem', fontWeight: 'bold', marginBottom: '1rem', color: 'var(--text-primary)' }}>Chat WhatsApp</h3>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginBottom: '0.5rem', fontWeight: '700' }}>+244 955 475 575</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '1.5rem' }}>Atendimento Seg-Sáb</p>
                        <a href="https://wa.me/244955475575?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20serviços%20da%20Natlou." target="_blank" rel="noopener noreferrer" style={{ color: '#25D366', fontWeight: 'bold', textDecoration: 'none' }}>Iniciar Conversa →</a>
                    </div>
                    ...
                    <div style={{
                        ...
                        <h3 style={{ fontSize: '1.4rem', fontWeight: 'bold', marginBottom: '1rem', color: 'var(--text-primary)' }}>Escrever Email</h3>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', marginBottom: '0.5rem', fontWeight: '600' }}>natlou.limitada@gmail.com</p>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '1.5rem' }}>Respondemos em 24h</p>
