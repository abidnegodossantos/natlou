...
export default async function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="container section">
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{
                        ...
                        <h4 style={{ fontSize: '1rem', fontWeight: '700', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-primary)' }}>
                        ...
                        <div style={{ marginTop: '1rem', textAlign: 'center', fontSize: '0.85rem', color: 'var(--text-secondary)', fontStyle: 'italic' }}>
                            "Não sabe qual escolher? <a href="https://wa.me/244955475575?text=Olá!%20Preciso%20de%20ajuda%20técnica%20para%20escolher%20o%20AC%20certo." target="_blank" rel="noopener noreferrer" style={{ color: 'var(--secondary-color)', fontWeight: '600' }}>Fale com o nosso técnico.</a>"
                        </div>
                    </div>
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        <div style={{ fontSize: '1rem', color: '#28a745', fontWeight: '700' }}>
            ...
            <div style={{ backgroundColor: 'var(--bg-card)', borderRadius: '24px', padding: '3rem', boxShadow: '0 10px 40px var(--shadow-color)' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px' }}>
                        ...
                        <span style={{ fontWeight: '500', color: 'var(--text-primary)' }}>Aparelho de Ar Condicionado Novo (Na Caixa)</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: 'rgba(40, 167, 69, 0.15)', color: '#28a745', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        </div>
                        <span style={{ fontWeight: '500', color: 'var(--text-primary)' }}>Montagem Profissional (Oferta)</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: 'rgba(40, 167, 69, 0.15)', color: '#28a745', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px' }}>
                        ...
                        <span style={{ fontWeight: '500', color: 'var(--text-primary)' }}>1ª Manutenção Grátis após instalação</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', backgroundColor: 'var(--bg-secondary)', padding: '1.5rem', borderRadius: '12px' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', backgroundColor: 'rgba(40, 167, 69, 0.15)', color: '#28a745', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <span style={{ fontWeight: '500', color: 'var(--text-primary)' }}>Garantia de Stock Real</span>
            ...
            <div style={{ marginTop: '4rem', marginBottom: '6rem' }}>
                <h3 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '1.5rem', color: 'var(--text-primary)', textAlign: 'center' }}>
                    Já tem um AC antigo?
                </h3>
                <div style={{
                    display: 'grid',
                    ...
                    <div style={{
                        ...
                        <div>
                            <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: '0.3rem' }}>Serviço Rápido</div>
                            <div style={{ fontSize: '1.1rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '0.2rem' }}>Manutenção Preventiva</div>
                            <div style={{ fontSize: '1.2rem', fontWeight: '800', color: 'var(--primary-color)' }}>10.000 Kz</div>
                        </div>
                        <a
                            href="https://wa.me/244955475575?text=Olá!%20Gostaria%20de%20agendar%20uma%20Manutenção%20Preventiva%20(10.000%20Kz)."
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{
                                backgroundColor: 'var(--bg-secondary)',
                    ...
                    <div style={{
                        ...
                        <div>
                            <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: '0.3rem' }}>Restaurar Potência</div>
                            <div style={{ fontSize: '1.1rem', fontWeight: '700', color: 'var(--text-primary)', marginBottom: '0.2rem' }}>Carga de Gás</div>
                            <div style={{ fontSize: '1.2rem', fontWeight: '800', color: 'var(--primary-color)' }}>15.000 Kz</div>
                        </div>
                        <a
                            href="https://wa.me/244955475575?text=Olá!%20Gostaria%20de%20solicitar%20uma%20Carga%20de%20Gás%20(15.000%20Kz)."
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{
                                backgroundColor: 'var(--bg-secondary)',
